...
{
//    [self.navigationBar setBackgroundImage:[UIImage imageTintedWithColor:[UIColor colorWithWhite:1.0 alpha:alpha] toSize:CGSizeMake(1.f, 1.f)] forBarMetrics:UIBarMetricsDefault];
//     导航栏背景透明度设置
    if (![self.navigationBar subviews].count) {// QQ 弹起网页登录
        return;
    }
