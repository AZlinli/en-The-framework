...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        for (int i = 0; i < starNumber; i++) {
            UIImage * grayImg = [UIImage imageNamed:@"list_comment_star_unselect"];
            ...
            UIImage * foreImg = [UIImage imageNamed:@"list_comment_star_selected"];
            ...
            foreImgView.contentMode = UIViewContentModeScaleAspectFill;
